...
const Login = () => {
  ...
  return (
    <div className="w-full relative overflow-x-hidden overflow-y-hidden h-screen flex justify-center items-center bg-white md:bg-white lg:bg-[#FFF9E5]">
      ...
      {/* LEFT PART (Background Rectangles, Trophy, Desktop Logo) - SHOW only on large screens */}
      ...
      {/* Mobile Logo (visible on tablets and mobiles only) */}
      ...
      <div className='w-full md:w-full lg:w-[50%] absolute right-0 md:h-full h-screen bg-white rounded-b-4xl shadow-2xl rounded-t-4xl z-10'>
        <div className="w-[90%] lg:w-[100%] md:w-[100%]  max-w-[340px] lg:max-w-[450px] md:max-w-[600px]   mx-auto mt-20 lg:mt-40 md:mt-70 z-10 bg-white px-6 py-8 rounded-md ">
          ...
          <div className="mb-6 relative">
            <label className="block text-gray-400 text-sm mb-1" htmlFor="password"></label>
            <input
          ...
          <button className="w-full lg:text-lg lg:font-semibold lg:h-[40px] bg-yellow-400 text-white md:text-2xl md:font-bold md:h-[50px] font-semibold py-1 rounded-md mb-1 hover:bg-yellow-500 transition duration-300">
            Login
          </button>
