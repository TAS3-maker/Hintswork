...
import phoneGam from '../assets/phoneGam.png'; // update with your phone image path
import bulbMessage from '../assets/bulbmessage.png'; // update with your bulb message icon path
import medal from '../assets/medal2.png'; // update with your trophy icon path

const Gamification = () => {
  return (
    <div className="w-full px-4  md:px-16 mt-15 py-10">
      {/* Heading */}
      <h1 className="text-4xl md:text-5xl  font-bold text-red-500 text-center font-Montserrat tracking-wide">
        Gamification
      </h1>
      {/* Main content */}
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-10 md:gap-20 relative">
        ...
        <img
          src={medal}
          alt="Trophy Icon"
          className="hidden md:block absolute left-0  top-35 right-2 w-32"
        />
        {/* Text content */}
        ...
        {/* Phone image with yellow bg shape */}
