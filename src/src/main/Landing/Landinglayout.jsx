...
import { BookDemoProvider } from "./Context/BookDemoContext.js";
import home from "../assets/Home.png";
// import './index.css';
// ...existing code...
const Landinglayout = () => {
  return (
    <div className="relative font-sans  bg-contain bg-no-repeat min-h-screen w-full max-w-[1496px] m-auto" >
      <img
        src={home}
        alt="Decorative background"
        className="hidden md:block absolute top-0 right-0 object-cover z-0 pointer-events-none"
      /> 
